  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-4 sm:py-8">
      ...
      <div className="mb-6 flex flex-col gap-3 sm:mb-8 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="mb-1 text-2xl font-bold text-gray-900 sm:mb-2 sm:text-3xl">{t('title')}</h1>
          <p className="text-sm text-gray-600 sm:text-base">{t('subtitle')}</p>
        </div>

        {/* Period Selector */}
        <div className="flex self-start gap-1 rounded-lg bg-gray-100 p-1 sm:gap-2">
        ...
        <div className="mb-6 grid grid-cols-2 gap-3 sm:mb-8 sm:grid-cols-4 sm:gap-4">
          <div className="rounded-lg bg-white p-3 shadow-md sm:p-6">
            <div className="mb-2 flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-xs text-gray-600 sm:text-sm">{t('avgCalories')}</span>
            </div>
            <p className="text-xl font-bold text-gray-900 sm:text-2xl">{Math.round(summary.avgCalories)}</p>
          ...
          <div className="rounded-lg bg-white p-3 shadow-md sm:p-6">
            <div className="mb-2 flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-xs text-gray-600 sm:text-sm">{t('goalsMetDays')}</span>
            </div>
            <p className="text-xl font-bold text-gray-900 sm:text-2xl">{goalSuccessRate}%</p>
          ...
          <div className="rounded-lg bg-white p-3 shadow-md sm:p-6">
            <div className="mb-2 flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-xs text-gray-600 sm:text-sm">{t('streak')}</span>
            </div>
            <p className="text-xl font-bold text-gray-900 sm:text-2xl">{summary.streak}</p>
          ...
          <div className="rounded-lg bg-white p-3 shadow-md sm:p-6">
            <div className="mb-2 flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-xs text-gray-600 sm:text-sm">{t('loggedDays')}</span>
            </div>
            <p className="text-xl font-bold text-gray-900 sm:text-2xl">{summary.totalDays}</p>
            <p className="mt-1 text-xs text-gray-500">{t('daysUnit')}</p>
          </div>
        </div>
      )}
