          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            ...
            <form onSubmit={editingRecord ? handleEditWeight : handleAddWeight} className="space-y-4">
              ...
              <div className="flex gap-3">
                <button type="button" onClick={() => { setShowAddModal(false); setEditingRecord(null); setFormData({ weight: "", bodyFat: "", note: "", date: new Date().toISOString().split("T")[0] }); }} className="flex-1 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">{tc('cancel')}</button>
