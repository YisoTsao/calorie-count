  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-8">
        <p className="py-12 text-center text-gray-400">載入中...</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="mb-2 text-3xl font-bold text-gray-900">數據分析</h1>
      ...
      {summary && (
        <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-4">
          <div className="rounded-lg bg-white p-6 shadow-md">
            ...
            <p className="mt-1 text-xs text-gray-500">kcal/天</p>
          </div>
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            ...
            <p className="mt-1 text-xs text-gray-500">天</p>
          </div>
      ...
      <div className="mb-8 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <TrendChart data={nutrientsData} type="nutrients" title="三大營養素趨勢" />

          {weightData.length > 0 && <TrendChart data={weightData} type="weight" title="體重變化" />}
        </div>

        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <TrendChart data={waterData} type="water" title="飲水量趨勢" />

          <TrendChart data={exerciseData} type="exercise" title="運動時長趨勢" />
        </div>
      </div>
      ...
      <div className="mt-8 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 p-6">
        <h3 className="mb-3 text-lg font-semibold text-gray-900">健康建議</h3>
          ...
          {summary && summary.avgCalories > 0 && (
            <>
              {summary.avgCalories > 2500 && (
                <div>
                  <p className="mb-1 font-medium">卡路里攝取偏高</p>
              ...
              {summary.avgWater < 1500 && (
                <div>
                  <p className="mb-1 font-medium">飲水量不足</p>
                  <p className="text-gray-600">
              ...
              {summary.avgExercise < 30 && (
                <div>
                  <p className="mb-1 font-medium">運動量不足</p>
                  <p className="text-gray-600">
              ...
              {summary.streak >= 7 && (
                <div>
                  <p className="mb-1 font-medium">堅持打卡</p>
                  <p className="text-gray-600">太棒了!已連續記錄 {summary.streak} 天,繼續保持!</p>
                </div>
              )}

              {goalSuccessRate >= 80 && (
                <div>
                  <p className="mb-1 font-medium">目標達成優秀</p>
                  <p className="text-gray-600">目標達成率 {goalSuccessRate}%,表現很好!</p>
                </div>
              )}
            </>
          )}
