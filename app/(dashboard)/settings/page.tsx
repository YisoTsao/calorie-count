...
import { Settings, User, Target, Palette, Database, Shield, Info, Save } from 'lucide-react';
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setProfile({ ...profile, gender: e.target.value as 'male' })}
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setProfile({ ...profile, gender: e.target.value as 'female' })}
                    className="w-4 h-4 text-blue-600"
                  />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setGoals({ ...goals, dailyCalorieGoal: parseInt(e.target.value) })}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setGoals({ ...goals, waterGoal: parseInt(e.target.value) })}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                placeholder="2000"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setGoals({ ...goals, exerciseGoal: parseInt(e.target.value) })}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                placeholder="30"
              />
            </div>
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setPreferences({
                      ...preferences,
                      notifications: { ...preferences.notifications, mealReminder: e.target.checked }
                    })}
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setPreferences({
                      ...preferences,
                      notifications: { ...preferences.notifications, achievementNotif: e.target.checked }
                    })}
                    className="w-4 h-4 text-purple-600 rounded"
                  />
